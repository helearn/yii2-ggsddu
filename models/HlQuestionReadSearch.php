...
/**
 * HlQuestionReadSearch represents the model behind the search form of `helearn\ggsddu\models\HlQuestionRead`.
 */
class HlQuestionReadSearch extends HlQuestionRead
{
    /**
     * {@inheritdoc}
     */
