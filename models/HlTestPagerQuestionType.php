 ...
 */
class HlTestPagerQuestionType extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return HlTestPagerQuestionTypeQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new HlTestPagerQuestionTypeQuery(get_called_class());
    }
}
