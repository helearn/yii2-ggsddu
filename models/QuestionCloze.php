 ...
 * @property int $correct_answer 正确答案【以|#|分割每个填空】
 ...
 */
class QuestionCloze extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return QuestionClozeQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new QuestionClozeQuery(get_called_class());
    }
}
