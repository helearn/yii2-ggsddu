 ...
 */
class HlQuestionReadStem extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return HlQuestionReadStemQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new HlQuestionReadStemQuery(get_called_class());
    }
}
