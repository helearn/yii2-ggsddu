...
/**
 * HlQuestionCompletionSearch represents the model behind the search form of `helearn\ggsddu\models\HlQuestionCompletion`.
 */
class HlQuestionCompletionSearch extends HlQuestionCompletion
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = HlQuestionCompletion::find();
